...
C 1         X IS MAGNETIC WEST                                          CNTL 110
C 2         Y IS MAGNETIC SOUTH                                         CNTL 120
C 3         Z IS ALTITUDE                                               CNTL 130
C                                                                       CNTL 140
C 4    HOB IS HEIGHT OF BURST IN KILOMETERS > 50KM                      CNTL 150
C                                                                       CNTL 160
C 5    GAMYLD IS GAMMA YIELD OF BURST IN KILOTONS                       CNTL 170
C                                                                       CNTL 180
C 6    BFIELD IS THE MAGNITLDE OF EARTHS MAGNETIC FIELD IN THE          CNTL 190
C      ABSORPTICN REGICN BELOW THE BURST IN WEBERS/SQUARE METER         CNTL 200
C                                                                       CNTL 210
C 7    BANGLE IS THE DIP ANGLE OF THE MAGNETIC FIELD IN DEGREES         CNTL 220
C                                                                       CNTL 230
C 8    NDELR IS NUMBER OF STEPS BETWEEN RMIN AND RMAX                   CNTL 240
C      50<=NDELR<=500                                                   CNTL 250
C                                                                       CNTL 260
C 9    OUX IS THE OUTPUT CONTROL PARAMETER                              CNTL 270
...
C     CALL ELGPLT (E,TIMX,BIG) OLD PRINT CALL                           CNTl1170
C           NEW SUBROUTINE FOR CREATING GNUPLOT FILE
C           CALL ADDED BY MERLYN (DRFORBIN) COUSINS
 ...
 2006 FORMAT("     THE BLAST WITH GAMMA YIELD OF",1PE10.3," KILOTONS"   CNTL1250
...
C                                                                       EFLD 670
 42   PRINT 201,TIMX(ITER)                                              EFLD 680
      RETURN                                                            EFLD 690
C                                                                       EFLD 700
C          PRINT MESSAGE AFTER ABNORMAL TERMINATION OF TIME LOOP        EFLD 710
C                                                                       EFLD 720
...
C         PRI IS NUMBER OF PRIMARY ELECTRONS GENERATED DURING TP        CMTN 140
C         PRI2 IS NUMBER OF PRIMARY ELECTRONS GENERATED DURING T        CMTN 150
...
C                                                                       CMTN 190
      ...
      PRI2=0.                                                           CMTN 230
C                                                                       CMTN 240
C         RUNGE-KUTTA INTEGRATICN OF COMPTON CURRENT                    CMTN 250
C                                                                       CMTN 260
...
C
C
      SUBROUTINE PLOT(E,TIMX,BIG,NMAX)
C
